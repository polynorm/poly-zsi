...
class Base:
    ...
    def __init__(self, module=__name__):
        self.loggername = '%s-%s(%s)' %(module, self.__class__, _get_idstr(self))
...
class DOM:
    ...
    _xsd_uri_mapping = dict((v, k) for k, v in _xsd_uri_mapping.iteritems())
#    for key, value in _xsd_uri_mapping.iteritems():
