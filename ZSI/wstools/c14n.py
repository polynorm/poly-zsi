...
#                if not inclusive and a.prefix is not None and not ('xmlns:%s' %a.prefix) in ns_rendered:
#                    ns_local['xmlns:%s' %a.prefix] = ??
        ...
        if in_subset: 
            ...
            if not inclusive:
                ...
                if not prefix in ns_rendered and not prefix in ns_local:
            ...
            for n,v in ns_local.iteritems():
                ...
                if n not in ns_rendered or ns_rendered[n] != v:
            ...
            for n,v in sorted(ns_to_render, _sorter_ns):
                self._do_attr(n, v)
            ...
            for a in sorted(other_attrs, _sorter):
